...
- [x] **Step 4: Install and run the smoke test**
...
- [x] **Step 6: Write `config.example.yaml`**
...
- [x] **Step 1: Write the failing test for events**
...
- [x] **Step 5: Write the failing test for the bus**
...
- [x] **Step 3: Implement the token bucket**
...
- [x] **Step 5: Confirm endpoint paths against the OpenAPI spec**
...
- [x] **Step 3: Implement the base strategy**
...
- [x] **Step 4: Implement the SMA strategy**
...
- [x] **Step 3: Implement the risk manager**
...
- [x] **Step 3: Implement the broker base**
...
- [x] **Step 4: Implement the simulated broker**
...
- [x] **Step 3: Implement the feed base**
...
- [x] **Step 4: Implement the historical feed**
...
- [x] **Step 3: Implement the notifier base**
...
- [x] **Step 4: Implement the Telegram notifier**
...
- [x] **Step 1: Write the failing test for metrics**
...
- [x] **Step 4: Add repo helpers (Modify `src/etorobot/persistence/repo.py`)**
...
- [x] **Step 5: Create the strategy registry**
...
- [x] **Step 6: Write the failing test for the runner**
...
- [x] **Step 8: Run both backtest test files**
...
- [x] **Step 1: Write the failing test (client is faked)**
...
- [x] **Step 3: Implement the live broker**
...
- [x] **Step 5: Verify response field names against the real demo API**
...
- [x] **Step 1: Write the failing test for the aggregator**
...
- [x] **Step 3: Implement the aggregator and live feed**
...
- [x] **Step 5: Smoke-test the WebSocket payload shape**
...
- [x] **Step 1: Write the failing test for instrument resolution**
...
- [x] **Step 3: Add `resolve_instrument` (Modify `src/etorobot/data/client.py`)**
...
- [x] **Step 5: Confirm the by-symbol endpoint**
...
- [x] **Step 6: Write the failing test for the CLI backtest path**
...
- [x] **Run the whole suite:** `pytest -v` → all green.
- [x] **Backtest end-to-end (real demo keys in `.env`, `config.yaml` from example):**
  `etorobot --config config.yaml backtest --candles 500` → prints metrics.
- [x] **Confirm inferred endpoints** (Tasks 6/15/17 verification steps) are
  resolved against the OpenAPI spec / real demo responses.
- [x] **Live smoke (demo only):** `etorobot --config config.yaml run` for a few
